...
\textbf{8.} *Apresente os gráficos da questão anterior e copie os comandos de medida
   e sinais de entrada que usou no \emph{ELDO}.
    ...
    As formas de onda dos sinais de entrada $A$, $B$ e $C$ e a saída $S$ obtida pelas simulação 
    estão na imagem \ref{imgSinEntQ8}.

    Quando mantemos o sinal $A$ em nível lógico alto e o sinal $C$ em nível lógico baixo, o circuito
    lógico da questão 1 funciona como uma porta inversora com entrada em $B$ e saída $S$. Pode-se 
    observar na figura \ref{imgSinEntQ8} que, como esperado, a saída é a negação de $C$.
   ...
   cruzamento com o eixo Y (eixo de tempo).
    ...
    \begin{table}[!hp]
        ...
        \begin{tabular}{|l|r|r|}
            ...
            Coeficiente Angular &               1386,8  &               1335,8  \\  \hline 
            Coeficiente Linear  &   $0,15\cdot10^{-9}$  &   $0,10\cdot10^{-9}$  \\  \hline
        \end{tabular}
    \end{table}
...
\textbf{26.} *Para as curvas tempo de propagação na subida e descida geradas a
   ...
   *** Calcular!!!
   A partir das equações xxxx calculou-se os coeficientes angular e linear. Estes estão apresentados na tabela
   \ref{tblCalQ26}.

   \begin{table}[!hp]
        \caption{\label{tblCalQ26}Coeficientes angular e linear para as curvas de atraso alto-alto e baixo-baixo,
                obtidas na simulação da porta lógica não inversora com circuitos parasitas.}
        \centering
        \begin{tabular}{|l|c|c|}
            \hline
            Atraso  &   Coef. Angular   &   Coef. Linear    \\  \hline
            Alto-alto   &   xxx &   xxx \\  \hline
            Baixo-baixo &   yyy &   yyy \\  \hline
        \end{tabular}
   \end{table}
