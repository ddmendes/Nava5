...
\textbf{8.} *Apresente os gráficos da questão anterior e copie os comandos de medida
   e sinais de entrada que usou no \emph{ELDO}.
    ...
    \img{Atraso de subida e descida por capacitância de carga.}{imgApcQ8}{atraso_por_capacitancia_q8.jpg}

    \img{Sinais de entrada e saída da porta lógica}{imgSinEntQ8}{sinais_entrada_saida_q8.jpg}
