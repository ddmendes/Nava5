...
sinal de saída, \emph{saida32\_33} (divide o \emph{clock} por 32 ou 33).
	...
	%\img{Esquemático do circuito \emph{prescaler} 32/33}{imgQ01schematic} \\ XXX adicionar figura
\bigskip
...
o \emph{layout} feito e corrigido.
    ...
    O \emph{layout} do circuito está representado na \fref{imgQ04layout}.

	%\img{\emph{Layout} do circuito \emph{prescaler} 32/33}{imgQ04layout} \\ XXX adicionar figura
\bigskip
...
prescaler anterior (faça as devidas checagens).
	...
	O esquemático do circuito utilizando o \emph{prescaler} está representado na \fref{imgQ07schematic}.

	%\img{Esquemático do circuito utilizando \emph{prescaler} 32/33}{imgQ07schematic} \\ XXX adicionar figura
\bigskip
