...
\textbf{16.} Feche o Leonardo e abra novamente. Leia o \emph{VHDL}, mas tome cuidado para
   ...
   Após as otimizações, foi encontrado, para o caminho crítico, um valor de atraso de $1,11 ns$.
   O esquemático da máquina de estados está representado na \fref{imgQ16schematic}
   
   \img{Esquemático da máquina de estados}{imgQ16schematic} % XXX adicionar imagem
\bigskip
...
\textbf{18.} Faça as verificações com \emph{DRC} e \emph{LVS} e apresente o \emph{layout} final.
    ...
    \img{\emph{Layout} da máquina de estados}{imgQ18layout} % XXX adicionar imagem
\bigskip
