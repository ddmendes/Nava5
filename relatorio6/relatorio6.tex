...
\textbf{15.} *Simule no \emph{ModelSim} o circuito e verifique seu funcionamento.
  ...
  O resultado da simulação se encontra na \fref{imgQ15simulation}.

  \img{Simulação no \emph{ModelSim} do \emph{Prescaler} completo}{imgQ15simulation} % TODO adicionar figura
\bigskip
